...
MAPI_Plot2 <- function(resu, tails=NULL, samples=NULL, pal=c("#994000", "#CC5800", "#FF8F33", "#FFAD66", "#FFCA99", "#FFE6CC", "#FBFBFB", "#CCFDFF", "#99F8FF", "#66F0FF", "#33E4FF", "#00AACC", "#007A99"), shades=20, main="", upper=TRUE, lower=TRUE, upper.border="black", lower.border="gray") {
    ...
    if (!requireNamespace("sf", quietly=TRUE)) { stop("Package \"sf\" is required for this function. Please install it.", call. = FALSE) }
    if (!requireNamespace("ggplot2", quietly=TRUE)) { stop("Package \"ggplot2\" is required for this function. Please install it.", call. = FALSE) }
